...
int client_send_hello(client_t *client, char *host,uint16_t req_id);
int client_send_reg(client_t *client, char *host,char * port,uint16_t req_id);
int client_send_req(client_t *client, char *host,char * port,uint16_t req_id);
...
int client_send_reqrelay(client_t *client, char *host, char *port,uint16_t req_id,uint16_t relays);
